...
test = pd.read_csv("/media/audiodsp/ExternalVolume/Google_speech_command/recordings_19_06_2018/audio_recordings/01_down/1down.txt")
...
for i in range(length):
    ...
    file_1 = test.iloc[i]
    X_file = prepare_data(file_1,config,'/media/audiodsp/ExternalVolume/Google_speech_command/recordings_19_06_2018/audio_recordings/1_down/')
    #file_1 = train.iloc[7]
